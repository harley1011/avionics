...
const int DROGUE_EMATCH = 1; //Pin connected to drogue parachute e-match
const int MAIN_EMATCH = 2; //Pin connected to main parachute e-match
...
void loop()
{
 ...
 if (vertAccel < ACCEL_THRESH) 
 {
  ...
  digitalWrite(DROGUE_EMATCH, HIGH);
  //Read 9-DOF data
  //Read BMP180 data
  //Read GPS data
  //Write data to Xbee
